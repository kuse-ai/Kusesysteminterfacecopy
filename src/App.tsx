...
import { ChevronRight, ChevronDown, Folder, FileText, Image as ImageIcon, File as FileIcon } from "lucide-react";
...
export default function App() {
  ...
  const [activeView, setActiveView] = useState<"files" | "skill">("files");
